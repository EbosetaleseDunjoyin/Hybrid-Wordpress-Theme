...
if (!defined("DEVWP_CSS_DIR")) {
	define("DEVWP_CSS_DIR", untrailingslashit(get_template_directory()) . '/css');
}

if (!defined("DEVWP_CSS_URI")) {
	define("DEVWP_CSS_URI", untrailingslashit(get_template_directory_uri()) . '/css');
}
...
function devwp_scripts() {
	...
	wp_enqueue_style('devwp_bootstrap_icons', "//cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css", [], 1.1, "all");
